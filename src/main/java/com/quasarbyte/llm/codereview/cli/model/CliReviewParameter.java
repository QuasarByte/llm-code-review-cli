 ...
 * </p>
 */
public class CliReviewParameter {
    /**
     ...
     */
    private List<CliReviewTarget> targets;
     ...
     */
    private CliRhinoConfiguration rhinoConfiguration;
    ...
    public CliReviewParameter setReviewName(String reviewName) {
    ...
    public CliReviewParameter setRules(List<CliRule> rules) {
        this.rules = rules;
        return this;
    }
    ...
    public CliReviewParameter setRulesFilePaths(List<String> rulesFilePaths) {
        this.rulesFilePaths = rulesFilePaths;
        return this;
    }

    public List<CliReviewTarget> getTargets() {
        return targets;
    }

    public CliReviewParameter setTargets(List<CliReviewTarget> targets) {
    ...
    public CliReviewParameter setSystemPrompts(List<String> systemPrompts) {
    ...
    public CliReviewParameter setReviewPrompts(List<String> reviewPrompts) {
    ...
    public CliReviewParameter setLlmChatCompletionConfiguration(LlmChatCompletionConfiguration llmChatCompletionConfiguration) {
        this.llmChatCompletionConfiguration = llmChatCompletionConfiguration;
        return this;
    }

    public CliRhinoConfiguration getRhinoConfiguration() {
        return rhinoConfiguration;
    }

    public CliReviewParameter setRhinoConfiguration(CliRhinoConfiguration rhinoConfiguration) {
    ...
    public CliReviewParameter setRulesBatchSize(Integer rulesBatchSize) {
    ...
    public CliReviewParameter setTimeoutDuration(String timeoutDuration) {
        this.timeoutDuration = timeoutDuration;
        return this;
    }

    public CliLlmQuota getLlmQuota() {
        return llmQuota;
    }

    public CliReviewParameter setLlmQuota(CliLlmQuota llmQuota) {
    ...
    public CliReviewParameter setUseReasoning(Boolean useReasoning) {
